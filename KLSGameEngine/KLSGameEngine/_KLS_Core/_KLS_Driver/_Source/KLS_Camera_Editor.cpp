...
{
	// class constructor
	KLS_Camera_Editor::KLS_Camera_Editor(KLS_Driver* driver, KLS_KeyMap keymap) : KLS_Camera(driver)
	{
		m_KeyMap = keymap;
		m_FirstMouse = true;
		setActive(!m_Active);
	...
	// class destructor
	KLS_Camera_Editor::~KLS_Camera_Editor()
	{
	}

	void KLS_Camera_Editor::setActive(bool v)
	{
	...
	void KLS_Camera_Editor::onAnimate(const double& elapsedtime)
	{
