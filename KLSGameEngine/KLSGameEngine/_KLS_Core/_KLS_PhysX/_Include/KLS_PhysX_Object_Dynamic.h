...
namespace KLS
{
	class KLS_API KLS_PhysX_Object_Dynamic : public KLS_PhysX_Object
	{
	public:
		...
		// class variables
	private:
		physx::PxRigidDynamic* m_Actor = 0;
	...
	public:
		...
		virtual void setKenematic(bool v);
